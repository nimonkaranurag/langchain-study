...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fgit-guides)
...
[Sign in](/login?return_to=https%3A%2F%2Fgithub.com%2Fgit-guides)
 ...
 [Sign up](/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2Fgit-guides&source=header)
...
[Git](/git-guides) [Install](/git-guides/install-git) [Init](/git-guides/git-init) [Clone](/git-guides/git-clone) [Add](/git-guides/git-add) [Commit](/git-guides/git-commit) [Remote](/git-guides/git-remote) [Status](/git-guides/git-status) [Pull](/git-guides/git-pull) [Push](/git-guides/git-push)

[Sign up](/join?ref_cta=git_guides_nav_sign_up&ref_loc=git_guides_nav&ref_page=%2Fgit-guides&source=git_guides_nav)
...
Review code, manage projects, and build software alongside 40 million developers.
 ...
 [Sign up for GitHub](/join)   [Sign in](/login)
